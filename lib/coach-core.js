...
function buildTtsInput(text,mood,voiceStyle=""){
  return `Synthesize ONLY the Japanese transcript as natural speech.\nAudio profile: a refined, intelligent, youthful Japanese woman. Keep the voice slightly brighter and a touch higher than neutral, but never childlike or squeaky.\nScene: private casual conversation with someone she knows well.\nDirector's notes: ${ttsDirection(mood,voiceStyle)}. Use more emotional intonation and natural Japanese pitch movement than a neutral narrator. Vary pauses, pace and sentence endings. Do not sound flat, robotic, announcer-like, or exaggerated anime acting. Do not read any instructions aloud.\nSpoken transcript begins after this line:\n${String(text||"").trim().slice(0,500)}`;
}
