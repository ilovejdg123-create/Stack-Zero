...
module.exports=async(req,res)=>{
  ...
  try{
    ...
    const r=await generateAssistant(body);return res.status(200).json({ok:true,provider:"gemini",keyConfigured:true,ttsConfigured:Boolean(TTS_MODEL&&TTS_VOICE),ttsModel:TTS_MODEL,ttsVoice:TTS_VOICE,...r});
